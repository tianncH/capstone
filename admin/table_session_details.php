...
// Get session details
$session_sql = "SELECT ts.*, t.table_number 
...
// Get session orders (actual data)
...
// Get notifications
$notifications_sql = "SELECT * FROM table_session_notifications 
                      WHERE session_id = ? 
...
<body>
    <button class="back-button" onclick="window.close()" title="Close Tab">
                ...
                <div class="header-content">
                    <div class="header-left">
                        ...
                        <div class="session-info">
                            <h1 class="session-title">Table <?= $session['table_number'] ?> Session</h1>
                            <p class="session-subtitle">Session #<?= $session['session_id'] ?> • <?= ucfirst($session['status']) ?> Session</p>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value"><?= $session['closed_at'] ? date('h:i A', strtotime($session['closed_at'])) : 'Active' ?></div>
                            <div class="info-label">Session <?= $session['closed_at'] ? 'Closed' : 'Status' ?></div>
                        </div>
                        <div class="info-item">
                            ...
                            <div class="info-value">
                                ...
                                $end = $session['closed_at'] ? strtotime($session['closed_at']) : time();
                                $duration = $end - $start;
            ...
            <div class="card-body">
                    ...
                    <?php while ($order = $orders->fetch_assoc()): ?>
                        <div class="order-card">
                            <div class="order-header">
                                <div>
                                    <div class="order-number">#<?= htmlspecialchars($order['queue_number']) ?></div>
                            ...
                            <div class="order-body">
                                <div class="order-summary">
                                    ...
                                    <div class="summary-item">
                                        ...
                                        <div class="summary-value amount">₱<?= number_format($order['total_amount'], 2) ?></div>
                                    </div>
                                    <div class="summary-item">
                ...
                <?php else: ?>
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">No orders have been placed in this session yet.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
