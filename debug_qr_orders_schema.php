...
echo "<h2>🔍 QR ORDERS TABLE SCHEMA DEBUG</h2>";
...
try {
    echo "<h3>📊 QR Orders Table Structure:</h3>";
    
    // Get table structure
    $schema_sql = "DESCRIBE qr_orders";
    ...
    echo "<h3>📋 Sample QR Orders Data:</h3>";
    
    // Get sample data
    $sample_sql = "SELECT * FROM qr_orders ORDER BY created_at DESC LIMIT 5";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "No QR orders found.<br>";
    }
    
    echo "<h3>🔔 QR Session Notifications Table Structure:</h3>";
    
    // Get notifications table structure
    $notifications_schema_sql = "DESCRIBE qr_session_notifications";
    $result = $conn->query($notifications_schema_sql);
